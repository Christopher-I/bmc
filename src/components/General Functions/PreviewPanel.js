  ...
  return (
    <Box sx={containerStyle}>
      ...
      <Typography sx={paragraphStyle}>
        Post-haste Consulting Group pioneered a speciality in business
        partnerships beginning in 1990. During the 1990s it focused on mediating
        family and non-family business partner disputes. Those early clients
        taught PHCG's mediators about the approximately dozen different ways
        partners can wind up "sideways" with one another.
      </Typography>
