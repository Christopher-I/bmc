 ...
 * @param {number} testimonialNumber - The testimonial number (1 or 2)
 * @returns {string} - Safe image URL
 */

// Update the getSafeImageUrl function:
export const getSafeImageUrl = (imageSrc, testimonialNumber) => {
  if (!imageSrc || imageSrc === `/testimonial${testimonialNumber}_photo.jpeg`) {
    return `https://bmc-neon.vercel.app/testimonial${testimonialNumber}_photo.jpeg`;
  }
  return imageSrc;
};
      ...
      <div class="testimonials-wrapper">
        <div class="testimonials-image-container">
          <div class="testimonials-image-frame">
            <img class="testimonials-image" id="testimonialImage" src="${
        ...
        <div class="testimonials-content">
          ...
          <p class="testimonials-quote" id="testimonialQuote">${
            testimonials[0].quote
          }</p>
          <div class="testimonials-author" id="testimonialAuthor">${
            testimonials[0].author
          }</div>
          <div class="testimonials-title" id="testimonialTitle">${
...
export const generateTestimonialsEmbedCode = (config) => {
  const mergedConfig = {
    ...config,
    testimonial1Image: getSafeImageUrl(config.testimonial1Image, 1),
    testimonial2Image: getSafeImageUrl(config.testimonial2Image, 2),
  };
