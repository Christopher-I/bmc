...
export const getSafeImageUrl = (imageSrc) => {
  if (!imageSrc || imageSrc === "/dyp_tool.png") {
    return "https://bmc-git-sliversofambiguity-christopher-igbojekwes-projects.vercel.app/dyp_tool.png"; // Fallback to a hosted image
  }
  return imageSrc;
};
...
export const generateExternalScriptReference = (config) => {
  ...
  return `<script 
  src="https://bmc-git-sliversofambiguity-christopher-igbojekwes-projects.vercel.app/dyp_tool.png" 
...
export const defaultDYPToolConfig = {
  ...
  bodyFont: "sans-serif",
  imageRadius: 8,
  imageSrc: "https://bmc-git-sliversofambiguity-christopher-igbojekwes-projects.vercel.app/dyp_tool.png",
};
