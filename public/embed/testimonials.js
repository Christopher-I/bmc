...
(function () {
  ...
  // Update the config object in testimonials.js:
  const config = {
    ...
    testimonial1Image:
      currentScript.getAttribute("data-testimonial1-image") ||
      "https://bmc-neon.vercel.app/testimonial1_photo.jpg",
    testimonial2Image:
      currentScript.getAttribute("data-testimonial2-image") ||
      "https://bmc-neon.vercel.app/testimonial2_photo.jpg",
  };
        ...
        <div class="testimonials-wrapper">
          <div class="testimonials-image-container">
            <div class="testimonials-image-frame">
              <img class="testimonials-image" id="testimonialImage" src="${testimonials[0].image}" alt="Testimonial">
            </div>
          </div>
