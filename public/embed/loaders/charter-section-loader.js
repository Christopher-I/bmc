...
(function() {
    ...
    config['image-src'] = getSafeImageUrl(config['image-src'], "image");
    config['logo-src'] = getSafeImageUrl(config['logo-src'], "logo");
    ...
    placeholder.textContent = 'Loading Charter Section...';
    ...
    const loadStyles = async () => {
      try {
        const response = await fetch('https://bmc-neon.vercel.app/embed/styles/charter-section-styles.css');
    ...
    const loadContent = async () => {
      try {
        const response = await fetch('https://bmc-neon.vercel.app/embed/content/charter-section-content.html');
        ...
        placeholder.textContent = 'Error loading Charter Section';
        return false;
      }
    };
